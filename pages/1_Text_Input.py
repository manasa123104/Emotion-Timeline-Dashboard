...
st.title("Emotion Timeline — Text Input")
...
if not ready():
    ...
    text = st.text_area("Paste your script/lyrics here", height=240, placeholder="Paste text…")
    run = st.button("Analyze", disabled=bool(e_err))
